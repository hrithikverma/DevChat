    ...
    return (
      <Segment loading={!channel}>
        ...
        <Accordion styled attached="true">
          ...
          <Accordion.Content style={{ paddingLeft: "2vw" }} active={activeIndex === 0}>
          ...
          <Accordion.Content style={{ paddingLeft: "2vw" }} active={activeIndex === 1}>
          ...
          <Accordion.Content style={{ paddingLeft: "2vw" }} active={activeIndex === 2}>
            <Header as="h3">
